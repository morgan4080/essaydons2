export default {
  ...
  head: {
    ...
    title: 'Essaydons',
    script: [{ src: 'https://js.stripe.com/v3/', defer: true }, { src: "https://www.paypal.com/sdk/js?client-id=AYHrUgvtxhEEASQqu_wD-xzk4kk7jAlXuPnqc5oEiDy_WhfRHn5o3GkSrI013WBMZIwh1ue3Zn8YXLlw&currency=USD&intent=capture", "data-sdk-integration-source": "button-factory", defer: true }],
    meta: [
      { charset: 'utf-8' },
