export default {
  ...
  head: {
    ...
    title: 'Essaydons',
    script: [{ src: 'https://js.stripe.com/v3/', defer: true }, { src: "https://www.paypal.com/sdk/js?client-id=AXW8NcV5UU71HL1MOuQNFwKQoqnjmmWANlbZMajRMBB6aWSnCyyaDvwXonZNfdjc4tqVMsaIWSkeYO1I&currency=USD", "data-sdk-integration-source": "button-factory", defer: true }],
    meta: [
      { charset: 'utf-8' },
