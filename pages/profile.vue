                ...
                <div class="absolute flex flex-col top-0 text-xs overflow-auto w-full -mt-12">
                  <div class="flex justify-between items-center w-full overflow-hidden w-full lg:px-6">
                    ...
                    <dropdown :auto-close="true" class="flex items-center ml-auto" placement="bottom-start">
                      <svg class="cursor-pointer transform hover:scale-105 transition ease-in-out duration-100" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 12.5C7.5 11.1193 8.61929 10 10 10H40C41.3807 10 42.5 11.1193 42.5 12.5C42.5 13.8807 41.3807 15 40 15H10C8.61929 15 7.5 13.8807 7.5 12.5Z" fill="#111827"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 25C7.5 23.6193 8.61929 22.5 10 22.5H40C41.3807 22.5 42.5 23.6193 42.5 25C42.5 26.3807 41.3807 27.5 40 27.5H10C8.61929 27.5 7.5 26.3807 7.5 25Z" fill="#111827"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 37.5C7.5 36.1193 8.61929 35 10 35H40C41.3807 35 42.5 36.1193 42.5 37.5C42.5 38.8807 41.3807 40 40 40H10C8.61929 40 7.5 38.8807 7.5 37.5Z" fill="#111827"/>
                      </svg>
                      ...
                      <div slot="dropdown" class="mt-2 px-4 py-6 w-screen shadow-xl bg-white rounded max-w-custom">
                        <div @click="toggleTabs(1)" class="flex relative pb-3 mb-2 cursor-pointer">
                          ...
                          <div class="flex-shrink-0 w-10 h-10 inline-flex items-center justify-center text-white relative z-10">
                            <svg :class="{'': openTab !== 1, 'custom-fill': openTab === 1}" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M13.3435 3.82295C13.0576 2.75601 11.9609 2.12285 10.894 2.40873C9.82708 2.69462 9.19392 3.79129 9.4798 4.85822L9.99744 6.79007C10.2833 7.85701 11.38 8.49017 12.4469 8.20429C13.5139 7.9184 14.147 6.82173 13.8611 5.7548L13.3435 3.82295Z" fill="#111827"/>
                              <path d="M4.85822 9.4798C3.79129 9.19392 2.69462 9.82708 2.40873 10.894C2.12285 11.9609 2.75601 13.0576 3.82295 13.3435L5.7548 13.8611C6.82173 14.147 7.9184 13.5139 8.20429 12.4469C8.49017 11.38 7.85701 10.2833 6.79007 9.99744L4.85822 9.4798Z" fill="#111827"/>
                              <path d="M22.4851 8.34299C23.2662 7.56194 23.2662 6.29561 22.4851 5.51456C21.7041 4.73351 20.4377 4.73351 19.6567 5.51456L18.2425 6.92878C17.4614 7.70982 17.4614 8.97615 18.2425 9.7572C19.0235 10.5382 20.2899 10.5382 21.0709 9.7572L22.4851 8.34299Z" fill="#111827"/>
                              <path d="M8.34299 22.4851L9.7572 21.0709C10.5382 20.2899 10.5382 19.0235 9.7572 18.2425C8.97615 17.4614 7.70982 17.4614 6.92877 18.2425L5.51456 19.6567C4.73351 20.4377 4.73351 21.7041 5.51456 22.4851C6.29561 23.2662 7.56194 23.2662 8.34299 22.4851Z" fill="#111827"/>
                              <path d="M14.7428 12.143C14 11.8459 13.1516 12.02 12.5858 12.5858C12.0201 13.1515 11.846 13.9999 12.1431 14.7428L20.1431 34.7428C20.4356 35.474 21.13 35.9655 21.9169 35.9983C22.7038 36.031 23.4367 35.5989 23.7889 34.8944L26.548 29.3763L32.5858 35.4142C33.3669 36.1952 34.6332 36.1952 35.4143 35.4142C36.1953 34.6332 36.1953 33.3668 35.4143 32.5858L29.3764 26.5479L34.8945 23.7888C35.5989 23.4366 36.0311 22.7038 35.9983 21.9169C35.9656 21.13 35.4741 20.4355 34.7428 20.143L14.7428 12.143Z" fill="#111827"/>
                            </svg>
                          </div>
                        ...
                        <div @click="toggleTabs(3)" class="flex relative pb-3 mb-2 cursor-pointer">
                          ...
                          <div class="flex-shrink-0 w-10 h-10 inline-flex items-center justify-center text-white relative z-10">
                            <svg :class="{'def-stroke': openTab !== 3, 'custom-stroke': openTab === 3}" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M8 4C5.79086 4 4 5.79086 4 8V30C4 33.3137 6.68629 36 10 36C13.3137 36 16 33.3137 16 30V8C16 5.79086 14.2091 4 12 4H8ZM10 32C11.1046 32 12 31.1046 12 30C12 28.8954 11.1046 28 10 28C8.89543 28 8 28.8954 8 30C8 31.1046 8.89543 32 10 32Z" fill="#111827"/>
                              <path d="M20 28.4851L29.799 18.6862C31.3611 17.1241 31.3611 14.5914 29.799 13.0293L26.9705 10.2009C25.4084 8.63877 22.8758 8.63877 21.3137 10.2009L20 11.5146V28.4851Z" fill="#111827"/>
                              <path d="M32.0001 36H18.1421L30.1421 24H32.0001C34.2092 24 36.0001 25.7909 36.0001 28V32C36.0001 34.2091 34.2092 36 32.0001 36Z" fill="#111827"/>
                            </svg>
                          </div>
                          <div class="flex flex-col justify-center pl-4">
                        ...
                        <div @click="toggleTabs(5)" class="flex relative pb-3 mb-2 cursor-pointer">
                          ...
                          <div class="flex-shrink-0 w-10 h-10 inline-flex items-center justify-center text-white relative z-10">
                            <svg :class="{'': openTab !== 5, 'custom-fill': openTab === 5}" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M8 8C8 5.79086 9.79086 4 12 4H21.1716C22.2324 4 23.2499 4.42143 24 5.17157L30.8284 12C31.5786 12.7501 32 13.7676 32 14.8284V32C32 34.2091 30.2091 36 28 36H12C9.79086 36 8 34.2091 8 32V8ZM12 20C12 18.8954 12.8954 18 14 18H26C27.1046 18 28 18.8954 28 20C28 21.1046 27.1046 22 26 22H14C12.8954 22 12 21.1046 12 20ZM14 26C12.8954 26 12 26.8954 12 28C12 29.1046 12.8954 30 14 30H26C27.1046 30 28 29.1046 28 28C28 26.8954 27.1046 26 26 26H14Z" fill="#111827"/>
                            </svg>
                          </div>
                          <div class="flex flex-col justify-center pl-4">
