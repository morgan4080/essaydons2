                ...
                <div v-if="cartUIStatus === 'idle'">
                  <div class="flex flex-col justify-center items-center">
                    <div class="w-full md:w-11/12 mb-4">
                      <div class="flex items-center border-2 p-6 rounded-lg" :class="{'border-teal-300 bg-gray-100' : paymentMethod === 'stripe', 'border-gray-300' : paymentMethod !== 'stripe'}">
                      ...
                      >
                      <div v-show="paymentMethod === 'stripe'" class="px-5 rounded-lg border-2 border-teal-300 mt-2 py-6 bg-gray-100">
                    ...
                    <div class="w-full md:w-11/12">
                      <div class="flex items-center border-2 p-6 rounded-lg" :class="{'border-teal-300 bg-gray-100' : paymentMethod === 'paypal', 'border-gray-300' : paymentMethod !== 'paypal'}">
                      ...
                      <transition
                        ...
                        leave-to-class="transform -translate-y-6"
                      >
                      <div v-show="paymentMethod === 'paypal'" class="px-5 rounded-lg border-2 border-teal-300 mt-2 py-6 bg-gray-100">
                        <div class="">
