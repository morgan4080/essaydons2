  ...
  <div>
    ...
    <div>
      <div class="min-h-screen" style="background: #FBFBFB;">
        <div class="max-w-6xl mx-auto pt-40 lg:pt-60 z-10 relative px-8 lg:px-0 pb-48">
          <section class="text-gray-700 body-font">
            <div class="mx-auto flex md:flex-row flex-col items-center">
                ...
                <div class="w-full max-w-xs" >
                  ...
                  <form @submit.prevent="register" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" style="border: 1px solid rgba(66, 251, 183, 0.8);">
                    ...
                    <div class="mb-4">
                      ...
                      <input required name="phone" v-model="phone" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="phone" type="tel" placeholder="cell number">
                    </div>
                    <div class="mb-6">
                      ...
                      <!--border-red-500-->
                      <div class="relative">
                        <input required name="password" v-model="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" :type="!passwordFieldType ? 'password' : 'text'" placeholder="******************">
              ...
              <div class="lg:max-w-lg lg:w-full md:w-3/4 w-full">
...
export default {
  ...
  methods: {
    ...
    async register() {
      this.loading = true;
      try {
        const signupRes = await this.$axios.post('api/signup', {
          name: this.username,
          email: this.email,
          phone: this.phone,
